...
%	@date 6/4/18
%
function P = setdefaultparams_steak_alt
  addpath('./steaksrc/');
    ...
    P.datadir='.\feyesa_perm1e-16_realdiff_c_0_35\';
    P.outevery     = 60;  
   
    P.T_0 = 273+13; % Initial Temperature (K)
    P.T_D = 273+175; % Maximum Temperature (K)
    ...
    P.h = 33.4; % Heat transfer coefficient (W/ m^2.K) (Depends on oven, ranges 15-50)
    P.c_0 = 0.29; % Vapor concentration in boundary layer at 100% Humidity at 50 deg C(kg/m^3)
    ...
    P.kappa_perp = 1e-16; % Permiability of solid in x-direction (m^2)
    ...
    ly = 0.04/P.l; %ideal thickness
    lx = 0.04/P.l; %ideal width
    P.Ny = 24;
